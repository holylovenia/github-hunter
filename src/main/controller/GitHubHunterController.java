...
import main.view.DisclaimerScreen;
import main.view.ProcessedAsset;
import main.view.SearchScreen;
import main.view.StartScreen;

/**
 * Main main.test.controller for GUI and search data flow.
 *
...
public class GitHubHunterController {
   ...
   * main.test.controller, <code>searchController</code>, and <code>processedAsset</code>.</p>
   */
  ...
  /**
   * Sets main.test.controller usage up for other objects.
   */
